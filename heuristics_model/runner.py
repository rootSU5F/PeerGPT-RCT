...
import time  # Needed for rate limit sleep
...
# ✅ Static prompt (definitions once)
BIAS_RULES = """
...
def process_abstract(i, text):
    ...
    try:
        ...
        return [f"A{i+1:04d}", text.strip(), timestamp] + parsed_row[3:]
    except Exception as e:
...
# ✅ Parallel execution (adjust max_workers as needed)
results = []
